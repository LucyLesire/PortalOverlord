...
class Character : public PortalTraveller
{
public:
...
private:
	...
	float m_MaxPitch{50.f};
	float m_MinPitch{-50.f};
	...
	int m_ActionId_Fire{ -1 };

	ModelAnimator* m_pAnimator{};
	char** m_ClipNames{};
	UINT m_ClipCount{};

	GameObject* m_pChellObject{};

	TextureData* m_pCrossHairTexture{};
};
